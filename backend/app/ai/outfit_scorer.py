...
EVENT_CATEGORY_SCORE = {
    ...
    "sport": {
        ...
        "leggings": 1.0, "tracksuit": 1.0,
        "jeans": 0.3, "dress": 0.2, "blazer": 0.0,
    },
    "business": {
    ...
    "party": {
        "dress": 1.0, "heels": 1.0, "blazer": 0.8,
        "shirt": 0.7, "jeans": 0.6,
        "sneakers": 0.4, "hoodie": 0.1, "shorts": 0.3,
    },
}
...
def score_item(item, event_type: str, temperature: int) -> float:
    ...
    return round((t_score * 0.5) + (e_score * 0.5), 3)
