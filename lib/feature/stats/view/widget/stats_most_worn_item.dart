...
class StatsMostWornItem extends StatelessWidget {
  const StatsMostWornItem({
    super.key,
    required this.item,
    required this.wornTimesLabel,
  });

  final ClothingModel item;
  final String wornTimesLabel;
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: Text(
              '$wornTimesLabel ${item.wearCount}×',
              style: AppTextStyles.labelMediumActive,
            ),
          ),
        ],
      ),
